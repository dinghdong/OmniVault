...
export default function ProjectsSection() {
  ...
  const SubmitCTA = () => (
    <a href="/agent-sim" className="submit-project-cta">
      <div>
        <div className="submit-project-cta-title">Submit Project</div>
        <div className="submit-project-cta-sub">Mint an NFA identity and apply for funding</div>
      </div>
      <span className="submit-project-cta-arrow">Get Started →</span>
    </a>
  );
